...
namespace ArtFrame
{
    public static class InputHelper
    {
        public enum Keys
        {
            None = 0, Back = 8, Tab = 9, Enter = 13, CapsLock = 20, Escape = 27, Space = 32,
            ...
            ProcessKey = 229, Attn = 246, Crsel = 247, Exsel = 248, EraseEof = 249,
            Play = 250, Zoom = 251, Pa1 = 253, OemClear = 254,
            ChatPadGreen = 0xCA, ChatPadOrange = 0xCB, Pause = 0x13,
            ImeConvert = 0x1c, ImeNoConvert = 0x1d, Kana = 0x15, Kanji = 0x19,
            OemAuto = 0xf3, OemCopy = 0xf2, OemEnlW = 0xf4
        }
        ...
        public static class Keyboard
        {
            ...
            {
                _previous = _current;
                // Bridge: Silently using XNA to get the hardware state
                _current = Microsoft.Xna.Framework.Input.Keyboard.GetState();
            }

            public static bool IsKeyDown(Keys key) => _current.IsKeyDown((Microsoft.Xna.Framework.Input.Keys)key);

            // This is the "Professional" addition: detecting the initial tap
            public static bool IsKeyPressed(Keys key) =>
                _current.IsKeyDown((Microsoft.Xna.Framework.Input.Keys)key) &&
                _previous.IsKeyUp((Microsoft.Xna.Framework.Input.Keys)key);
        }
        ...
        public static class Mouse
        {
            ...
            // Using your own Vector2 and Point types
            public static Vector2 Position => new Vector2(_current.X, _current.Y);
            public static int CurrentScrollWheelValue => _current.ScrollWheelValue;
            public static int LastScrollWheelValue => _previous.ScrollWheelValue;
            ...
            public static bool LeftReleased() => _current.LeftButton == ButtonState.Released;
            public static bool LeftDown() => _current.LeftButton == ButtonState.Pressed;
            public static bool LeftClicked() =>
                _current.LeftButton == ButtonState.Pressed &&
                _previous.LeftButton == ButtonState.Released;

            public static bool RightReleased() => _current.RightButton == ButtonState.Released;
            public static bool RightDown() => _current.RightButton == ButtonState.Pressed;
        ...
        public static class InputManager
        {
            public static void Update()
            {
                Keyboard.Update();
                Mouse.Update();
                // You can add Controller support here later!
            }
        }
    }
}